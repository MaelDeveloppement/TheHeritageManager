...
import { TcoPdfReport } from './TcoPdfReport';
    ...
    return (
        ...
        <div style={{
            ...
            <header style={{ borderBottom: '1px solid #D9D2C5', paddingBottom: '24px', marginBottom: '32px' }}>
                ...
                <PDFDownloadLink
                    document={<TcoPdfReport assetName={initialAsset.name} params={params} projections={projections} />}
                    fileName={`Rapport_TCO_${initialAsset.name.replace(/\s+/g, '_')}.pdf`}
                    style={{
                ...
                >
                    {({ loading }) => (loading ? 'Préparation du rapport...' : 'Télécharger le rapport d\'évaluation')}
                </PDFDownloadLink>
            </header>
